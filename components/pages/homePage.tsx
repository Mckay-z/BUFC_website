  ...
  return (
    <main>
        ...
        <section className="relative min-h-screen w-full overflow-hidden">
          ...
          <div className="absolute inset-0">
            {heroNews.featuredImage ? (
              ...
              <div className="text-neutral-6 w-full h-full flex items-center justify-center">
                <Icon icon="material-symbols:news" width="80" height="80" />
              </div>
            )}
              ...
              <div className="max-w-140 sm:max-w-160 lg:max-w-180">
                ...
                {heroNews && (
                  <Button
                    ...
                    buttonClassName="!p-0 !text-neutral-1 hover:!text-primary transition-colors duration-300 ease-in-out text-sm md:text-base lg:text-lg"
                  >
                    Full Story
                  </Button>
                )}
      ...
      <section className="container-wide min-h-screen py-16 md:py-28">
        <div className="flex flex-col gap-30 justify-between h-full">
          {/* Section Header */}
          <SectionHeader
              ...
              >
                <div className="relative h-[400px] 2xlg:h-[460px] rounded-[20px] overflow-hidden">
                  ...
                  <div className="text-neutral-1 absolute bottom-0 left-0 right-0 px-5 sm:px-7.5 py-6">
                    <h3 className="uppercase text-base md:text-lg font-bold mb-2 leading-tight line-clamp-2">
                      {nextFourRecentNews && nextFourRecentNews[0].title
                        ? nextFourRecentNews[0].title
                        : "Untitled Article"}
                    </h3>
            ...
            <div className="flex flex-col xlg:flex-row gap-2.5 w-full 2xlg:w-2/3">
              ...
              <div className="bg-[#252424] rounded-[20px] px-5 sm:px-8 py-7.5 md:py-12 xlg:w-1/2 flex flex-col justify-between min-h-[350px] xlg:h-[420px] 2xlg:h-[460px]">
                ...
                <Button
                  ...
                  buttonClassName="!text-sm md:!text-base mt-6 !p-0 text-prim-3 hover:!text-prim-5 !justify-end"
                  fullWidth={true}
              ...
              <div className="grid grid-cols-2 grid-rows-[40%_1fr] xlg:w-1/2 gap-2.5 h-[400px] xlg:h-[420px] 2xlg:h-[460px]">
                {nextFourRecentNews.slice(1, 3).map((newsItem, index) => (
                  ...
                  >
                    {newsItem.featuredImage ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-sec-7 to-sec-9 flex items-center justify-center">
                ...
                >
                  {nextFourRecentNews[3].featuredImage ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-prim-6 to-prim-8 flex items-center justify-center">
                      <div className="text-white text-4xl">⚽</div>
                    </div>
                  )}
                </Link>
